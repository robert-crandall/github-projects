...
import {
  ...
  workIntakeAckSchema, workIntakeOutputSchema, workRankInputSchema, workRankOutputSchema, workObserveInputSchema,
} from './work-schema.ts';
...
export const requestSchema = z.discriminatedUnion('op', [
  ...
  z.strictObject({ ...envelope, op: z.literal('work.observe'), input: workObserveInputSchema }),
...
export const resultSchemas = {
  ...
  'work.observe': workCollectOutputSchema,
