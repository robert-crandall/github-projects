...
Use the selected semantic palette, system typography and restrained borders. The left pane contains Add task, Ranked Tasks, Settings and Connections. The middle pane contains the ranked list. The right pane contains task details, or a quiet selection prompt. List and details scroll independently. Keep all three panes visible above 900px.
